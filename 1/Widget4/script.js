...
// Initialize title
let title = localStorage.getItem('title4') || '';
document.getElementById('titleInput').value = title;
document.title = title;

// Generate slots for the progress bar
const initialNumSlots = localStorage.getItem('numSlots4') || 21;
...
function changeSlots() {
  ...
  updateProgressBar();
  localStorage.setItem('numSlots4', numSlots); // Save the number of slots
}
